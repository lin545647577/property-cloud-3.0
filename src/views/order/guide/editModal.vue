<template>
  <div class="normalForm">
    ...
    >
      ...
      <el-form-item label="发布人：" prop="workGuidePerson">
        <el-input
      ...
      <el-form-item label="热门：" prop="hot">
        <el-select v-model="form.hot" style="width: 100%" placeholder="请选择">
      ...
      <el-form-item label="发布结束时间：" prop="publishEndTime">
        <el-date-picker
      ...
      <el-form-item label="简要说明：" prop="simpleContent">
        <el-input
          type="textarea"
          autosize
          :disabled="checkInfo"
          placeholder="请输入"
          v-model="form.simpleContent"
        >
        </el-input>
      </el-form-item>
