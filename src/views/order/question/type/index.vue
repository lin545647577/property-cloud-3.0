<template>
  <div>
    <div class="search-box">
      <el-row :gutter="10" class="vertical-middle">
        <el-col :span="2" class="text-right vertical-middle">
          <div class="grid-content el-line-height">问题类型：</div>
        </el-col>
    ...
    >
      ...
      <el-table-column prop="name" label="问题类型" show-overflow-tooltip>
      </el-table-column>
  ...
  methods: {
    ...
    handleCheck(checkInfo, row) {
      ...
      this.$refs["editModal"].show({
        view: "order/question/type/editModal.vue",
    ...
    handleDelete(ids) {
      this.$confirm("确认删除?", "提示", {
        ...
        .then(() => {
          deleteQuestionType(ids).then((res) => {
            this.$message({
              message: "操作成功",
              center: true,
              type: "success",
