<template>
  <div>
    ...
    >
      ...
      <el-table-column label="关联住宅" show-overflow-tooltip>
        <template slot-scope="scope">{{ scope.row.residenceName }}</template>
      </el-table-column>
      <el-table-column label="状态" show-overflow-tooltip width="50">
...
<script>
import { queryCarParkDefinitionList } from "@/api/parking.js";
export default {
