<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="build_area" label="建筑面积" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="duty_user" label="联系人" show-overflow-tooltip>
      </el-table-column>
      <el-table-column
        prop="service_line"
        label="联系电话"
...
<script>
import { queryParkingTypeList } from "@/api/parking.js";
export default {
