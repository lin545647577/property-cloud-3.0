                ...
                <div class="grid-content content" style="height: 370px">
                  <el-row :gutter="20">
                    <el-col :span="12">
                      ...
                      <div
                        id="billBox"
                        class="grid-content bill-box"
                        @click="toPage('bill?type=4')"
                      ></div>
                    </el-col>
                      ...
                      <div class="grid-content">
                        ...
                        <el-row
                          style="
                            ...
                            color: #989eb2;
                          "
                          @click.native="toPage('bill?type=4')"
                        >
                          <el-col :span="12">
                            <div class="grid-content">
                              <p class="big-money">
                        ...
                        <el-row
                          @click.native="toPage('bill?type=4')"
                          style="color: #989eb2; margin-top: 50px"
                        >
                          <el-col :span="24">
                            <div class="grid-content">
                              <div
              ...
              <el-col :span="8">
                <div class="grid-content content" style="height: 370px">
                  ...
                  <div
                    ...
                    @click="toPage('project?type=2')"
                  ></div>
                  <div
                    class="float-box"
                    style="left: 41%; top: 47%; color: #3480f7"
                    v-if="projectData"
                    @click="toPage('project?type=2')"
                  >
                    <p class="float-num">
                      ...
                      <div class="face-box" v-if="faceData">
                        ...
                        <el-row style="margin: 35px 0">
                          <el-col :span="20">
                            ...
                            >
                              <countFaceSwiper
                                v-if="faceData.monthFaceFaceList.length > 1"
                                :imgList="faceData.monthFaceFaceList"
                              ></countFaceSwiper>
                            </div>
                          </el-col>
                          <el-col :span="4">
                            <div class="grid-content">
                              <el-avatar
                                :size="66"
                                v-if="faceData.monthFaceFaceList.length > 4"
              ...
              <el-col :span="8">
                <div class="grid-content content" style="height: 370px">
                  ...
                  <div
                    ...
                    id="qualityBox"
                    @click="toPageSelt('/taskProcess/instance')"
                  ></div>
                  <div
                    class="float-box"
              ...
              <el-col :span="24">
                <div class="grid-content" style="height: 485px">
                  <div style="position: relative">
                    <iframe
                      src="http://192.168.66.3/iframe"
                      class="device"
                      frameborder="0"
                      scrolling="no"
                    ></iframe>
                    <div class="float-title-box" @click="toPage('/monitors')">
                  ...
                  <el-row :gutter="20" style="margin-top: 16px">
                    <el-col :span="12">
                      <div
                        class="grid-content"
                        @click="toPage('baseSetting?type=10')"
                      >
                        <div
                          id="rentProperty"
              ...
              <el-col :span="24">
                <div class="grid-content" style="height: 121px">
                  ...
                  <el-row
                    ...
                    v-if="peceptionData"
                    @click.native="toPage('project?type=1')"
                  >
                    <el-col :span="6">
                      <div
                        class="grid-content"
...
import countFaceSwiper from "@/components/wiseScreen/countFaceSwiper";
...
export default {
  ...
  data() {
    return {
      // property2Url: "",
      property2Url: "http://wy.web.tank-light.com:63180/#/", //2.0地址
  ...
  methods: {
    // 2.0页面
    toPage(url) {
      window.open(this.property2Url + url, "_blank");
    },
    toPageSelt(url) {
        ...
        series: [
          ...
          },
          {
            ...
            data: [
              {
                value:
                  this.qualityData.totalRows - this.qualityData.completeRows,
                name: "未完成任务",
                emphasis: {
                  itemStyle: {
                    color: "#E2EEFE",
