...
export default {
  ...
  methods: {
    ...
    navigation(coordinates) {
      this.information.destination = "";
      this.calculate = false;
      if (this.endNode != this.current.name) {
        this.current = [];
      }
    ...
    subscribe(referenceCompanyCode) {
      ...
      let referenceCompanyCodenew = "COMP20211012172338000017";
      generateQrcCode(referenceCompanyCodenew).then((res) => {
        this.url = res.url;
      });
    },
