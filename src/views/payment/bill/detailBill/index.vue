        ...
        <div class="grid-content">
          <div class="search-box">
            <el-row :gutter="10" class="vertical-middle">
              ...
              <el-col :span="2" class="text-right vertical-middle">
                <div class="grid-content el-line-height">支付状态：</div>
              </el-col>
              <el-col :span="5" class="vertical-middle">
                <div class="grid-content">
                  <el-select
                  ...
                  >
                    ...
                    <el-option label="创建" value="build"></el-option>
                  </el-select>
                </div>
              </el-col>
              ...
              <el-col :span="3">
                ...
                >
                  <el-button size="small" type="primary">占位 </el-button>
                </div>
              </el-col>

              <el-col :span="2" class="text-right vertical-middle">
                <div class="grid-content el-line-height">支付方式：</div>
              </el-col>
              <el-col :span="5" class="vertical-middle">
                <div class="grid-content">
                  <el-select
          ...
          >
            ...
            <el-table-column label="支付方式" show-overflow-tooltip>
              <template slot-scope="scope" v-if="scope.row.payType">
                {{ findPayType(scope.row.payType) }}
              </template>
            </el-table-column>
            <el-table-column
              prop="collectionPeople"
              label="收款人"
              show-overflow-tooltip
            >
            </el-table-column>
...
export default {
  ...
  methods: {
    findPayType(pid) {
      let res = this.payType.find((item) => {
