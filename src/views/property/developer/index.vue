  ...
  <div>
    <div class="search-box">
      <el-row :gutter="10" class="vertical-middle">
        ...
        <!--        <el-col :span="2" class="text-right vertical-middle">-->
        <!--          <div class="grid-content el-line-height">联系地址：</div>-->
        <!--        </el-col>-->
        <!--        <el-col :span="5" class="vertical-middle">-->
        <!--          <div class="grid-content">-->
        <!--            <el-input v-model="searchAddress" placeholder="请输入内容"></el-input>-->
        <!--          </div>-->
        <!--        </el-col>-->
  ...
  methods: {
    ...
    handleExport() {
      this.$confirm("是否导出全部数据?", "提示", {
        ...
        .then(() => {
          ...
          exportDeveloperList({ name: this.searchName }).then((res) => {
    ...
    handleCheck(checkInfo, row) {
      ...
      this.$refs["editModal"].show({
        view: "property/developer/editModal.vue",
