<template>
  <el-row class="page-location" id="box">
    <!-- 左上侧搜索框 -->
    <div class="box-top">
      <el-col
        :span="24"
  ...
  methods: {
            ...
            series: [
...

              {
                ...
                symbol: function (value, params) {
                  let img =
                    "image://https://w3c.tank-light.com/static/大屏机/tengyuguangxun9.png";
                  return img;
                },
    ...
    findPositionByUserCilck(value) {
      if (value) {
        ...
        selectShowPointsDataForReservationInWisdomScreen(formDate).then(
          (res) => {
            console.log(res);
    ...
    navigation(coordinates) {
      ...
      this.$alert(
        ' <div style="bottom: 10%;background-color: #1993fc;z-index: 9999; height: 340px;border: none;color: #e5edff;font-size: 26px;text-align: center;">  <img style="margin-bottom: 20px;    margin-top: 20px;s" src=' +
          this.src +
          ' alt="" /> <p>请扫描二维码预约</p><div style="  position: absolute;left: 45%;bottom: -24px;    z-index: -1;width: 0;height: 0;border-left: 20px solid transparent;border-right: 20px solid transparent;border-top: 50px solid #1993fc;"></div></div>',

        {
          customClass: "bottom_box",
      ...
      setTimeout(function () {
        var bottom_box = document.getElementsByClassName("bottom_box")[0];
        console.log(bottom_box);
        bottom_box.style.border = "0px solid #EBEEF5";
        bottom_box.style.backgroundColor = "#ffffff00";
        bottom_box.style.boxShadow = "0 0px 0px 0 rgb(0 0 0 / 10%)";
        bottom_box.style.display = "inline-block";
        bottom_box.style.width = "380px";
      }, 100);
    },
