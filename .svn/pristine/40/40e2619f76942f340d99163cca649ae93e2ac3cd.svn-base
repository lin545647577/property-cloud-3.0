<template>
  <div>
    <div class="search-box">
      <el-row :gutter="10" class="vertical-middle">
        <el-col :span="4" class="text-right vertical-middle">
          <div class="grid-content el-line-height">开发商名称：</div>
        </el-col>
    ...
    >
      ...
      <el-table-column prop="name" label="公司名称" width="150" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="legalPerson" label="法人代表" show-overflow-tooltip>
      </el-table-column>
      ...
      <el-table-column prop="contacAddress" label="联系地址" width="150" show-overflow-tooltip>
      </el-table-column>
...
<script>
import { queryDeveloperList } from "@/api/property.js";
export default {
  name: "developerModal",
  data() {
    return {
