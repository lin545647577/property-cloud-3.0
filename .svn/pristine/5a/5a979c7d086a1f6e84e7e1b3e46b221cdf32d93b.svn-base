...
import {
  ...
  exportItemList,
  deleteItem,
  queryOwnerBillTableHeader,
  queryOwnerBillTableData,
} from "@/api/payment.js";
  ...
  methods: {
    ...
    handleCheck(checkInfo, row) {
      ...
      this.$refs["editModal"].show({
        view: "payment/bill/ownerBill/ownerDetailModal.vue",
        params: {
          checkInfo: checkInfo,
    ...
    initTableHeader() {
      queryOwnerBillTableHeader(this.referenceResidenceId).then((res) => {
        // console.log(res);
