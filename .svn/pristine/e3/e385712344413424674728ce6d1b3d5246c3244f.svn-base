<template>
  <div>
    <div class="search-box">
      <el-row :gutter="10" class="vertical-middle">
        <el-col :span="4" class="text-right vertical-middle">
          <div class="grid-content el-line-height">楼宇名称：</div>
        </el-col>
    ...
    >
      ...
      <el-table-column prop="residenceName" label="物业名称" show-overflow-tooltip>
      </el-table-column>
      ...
      <el-table-column prop="floorCnt" label="层数"> </el-table-column>
      <el-table-column prop="name" label="户数">
        <template slot-scope="scope">
          {{ scope.row.layerCnt }}
        </template>
      </el-table-column>
...
<script>
import { queryBuildingList } from "@/api/property.js";
export default {
  name: "buildingModal",
  data() {
    return {
