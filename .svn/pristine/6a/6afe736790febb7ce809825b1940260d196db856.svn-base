<template>
  <div>
    <div class="search-box">
      <el-row :gutter="10" class="vertical-middle">
        <el-col :span="2" class="text-right vertical-middle">
          <div class="grid-content el-line-height">联系人：</div>
        </el-col>
        ...
        <!--        <el-col :span="2" class="text-right vertical-middle">-->
        <!--          <div class="grid-content el-line-height">单位：</div>-->
        <!--        </el-col>-->
        <!--        <el-col :span="5" class="vertical-middle">-->
        <!--          <div class="grid-content">-->
        <!--            <el-input-->
    ...
    >
      ...
      <el-table-column label="联系电话" show-overflow-tooltip prop="phone">
      </el-table-column>
      <el-table-column label="单位" show-overflow-tooltip prop="company">
      </el-table-column>
      <el-table-column prop="content" label="留言" show-overflow-tooltip>
      </el-table-column>
  ...
  methods: {
    ...
    handleExport() {
      this.$confirm("是否导出全部数据?", "提示", {
        ...
        .then(() => {
          ...
          exportContactList({ name: this.searchName }).then((res) => {
            this.$message({
              message: "操作成功",
              center: true,
              type: "success",
    ...
    handleCheck(checkInfo, row) {
      ...
      this.$refs["editModal"].show({
        view: "phone/contact/editModal.vue",
