<template>
  <div>
    <div class="search-box">
      <el-row :gutter="10" class="vertical-middle">
        <el-col :span="4" class="text-right vertical-middle">
          <div class="grid-content el-line-height">楼层名称：</div>
        </el-col>
    ...
    >
      ...
      <el-table-column prop="nm" label="楼层编号"> </el-table-column>
      <el-table-column label="所属物业" prop="residenceName">
      </el-table-column>
      <el-table-column label="所属楼宇" prop="buildName">
      </el-table-column>
      <el-table-column prop="name" label="楼层名称"> </el-table-column>
      <el-table-column prop="layerCnt" label="户数"> </el-table-column>
    </el-table>
...
<script>
import { queryFloorList } from "@/api/property.js";
export default {
  name: "floorModal",
  data() {
    return {
